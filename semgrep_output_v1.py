...
class CiScanCompleteResponse:
    ...
    app_blocking_match_based_ids: List[str] = field(default_factory=lambda: [])
    ...
    def from_json(cls, x: Any) -> 'CiScanCompleteResponse':
        if isinstance(x, dict):
            return cls(
                ...
                app_blocking_match_based_ids=_atd_read_list(_atd_read_string)(x['app_blocking_match_based_ids']) if 'app_blocking_match_based_ids' in x else [],
            )
        else:
    ...
    def to_json(self) -> Any:
        ...
        res['app_blocking_match_based_ids'] = _atd_write_list(_atd_write_string)(self.app_blocking_match_based_ids)
        return res
