...
class CiScanMetadata:
    ...
    def from_json(cls, x: Any) -> 'CiScanMetadata':
        if isinstance(x, dict):
            return cls(
                ...
                using_products=_atd_read_list(Product.from_json)(x['using_products']) if 'using_products' in x else _atd_missing_json_field('CiScanMetadata', 'using_products'),
    ...
    def to_json(self) -> Any:
        ...
        res['using_products'] = _atd_write_list((lambda x: x.to_json()))(self.using_products)
