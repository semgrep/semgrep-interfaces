...
class EngineConfiguration:
    ...
    always_fail_open: bool = field(default_factory=lambda: False)
    ...
    def from_json(cls, x: Any) -> 'EngineConfiguration':
        if isinstance(x, dict):
            return cls(
                ...
                always_fail_open=_atd_read_bool(x['always_fail_open']) if 'always_fail_open' in x else False,
            )
        else:
    ...
    def to_json(self) -> Any:
        ...
        res['always_fail_open'] = _atd_write_bool(self.always_fail_open)
        return res
