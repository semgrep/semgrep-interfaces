...
class ProjectMetadata:
    ...
    base_commit: Optional[Sha1] = None
    ...
    def from_json(cls, x: Any) -> 'ProjectMetadata':
        if isinstance(x, dict):
            return cls(
                ...
                base_branch=_atd_read_string(x['base_branch']) if 'base_branch' in x else None,
                base_commit=Sha1.from_json(x['base_commit']) if 'base_commit' in x else None,
    ...
    def to_json(self) -> Any:
        ...
        if self.base_branch is not None:
            res['base_branch'] = _atd_write_string(self.base_branch)
        if self.base_commit is not None:
            res['base_commit'] = (lambda x: x.to_json())(self.base_commit)
