"""Generated by atdpy from type definitions in Semgrep_scan_output_v1.atd.

This implements classes for the types defined in 'Semgrep_scan_output_v1.atd', providing
...
class CoreError:
    ...
    def from_json(cls, x: Any) -> 'CoreError':
        if isinstance(x, dict):
            return cls(
                error_type=_atd_read_string(x['error_type']) if 'error_type' in x else _atd_missing_json_field('CoreError', 'error_type'),
