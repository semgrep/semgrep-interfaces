...
val write_constness :
  ...
  (** Output a JSON value of type {!constness}. *)

val string_of_constness :
  ?len:int -> constness -> string
  (** Serialize a value of type {!constness}
      into a JSON string.
      @param len specifies the initial length
                 of the buffer used internally.
                 Default: 1024. *)
...
val read_constness :
  ...
  (** Input JSON data of type {!constness}. *)

val constness_of_string :
  string -> constness
  (** Deserialize JSON data of type {!constness}. *)
...
val write_name_info :
  ...
  (** Output a JSON value of type {!name_info}. *)

val string_of_name_info :
  ?len:int -> name_info -> string
  (** Serialize a value of type {!name_info}
      into a JSON string.
      @param len specifies the initial length
                 of the buffer used internally.
                 Default: 1024. *)
...
val read_name_info :
  ...
  (** Input JSON data of type {!name_info}. *)

val name_info_of_string :
  string -> name_info
  (** Deserialize JSON data of type {!name_info}. *)

val write_name_or_dynamic :
  Bi_outbuf.t -> name_or_dynamic -> unit
  (** Output a JSON value of type {!name_or_dynamic}. *)

val string_of_name_or_dynamic :
  ?len:int -> name_or_dynamic -> string
  (** Serialize a value of type {!name_or_dynamic}
      into a JSON string.
      @param len specifies the initial length
                 of the buffer used internally.
                 Default: 1024. *)
...
val read_name_or_dynamic :
  ...
  (** Input JSON data of type {!name_or_dynamic}. *)

val name_or_dynamic_of_string :
  string -> name_or_dynamic
  (** Deserialize JSON data of type {!name_or_dynamic}. *)
...
val write_stmt_kind :
  ...
  (** Output a JSON value of type {!stmt_kind}. *)

val string_of_stmt_kind :
  ?len:int -> stmt_kind -> string
  (** Serialize a value of type {!stmt_kind}
      into a JSON string.
      @param len specifies the initial length
                 of the buffer used internally.
                 Default: 1024. *)
...
val read_stmt_kind :
  ...
  (** Input JSON data of type {!stmt_kind}. *)

val stmt_kind_of_string :
  string -> stmt_kind
  (** Deserialize JSON data of type {!stmt_kind}. *)
...
val write_type_parameter_constraint :
  ...
  (** Output a JSON value of type {!type_parameter_constraint}. *)

val string_of_type_parameter_constraint :
  ?len:int -> type_parameter_constraint -> string
  (** Serialize a value of type {!type_parameter_constraint}
      into a JSON string.
      @param len specifies the initial length
                 of the buffer used internally.
                 Default: 1024. *)
...
val read_type_parameter_constraint :
  ...
  (** Input JSON data of type {!type_parameter_constraint}. *)

val type_parameter_constraint_of_string :
  string -> type_parameter_constraint
  (** Deserialize JSON data of type {!type_parameter_constraint}. *)
