...
export function writeStats(x: Stats, context: any = x): any {
  return {
    'mean': _atd_write_required_field('Stats', 'mean', _atd_write_float, x.mean, x),
    'std_dev': _atd_write_required_field('Stats', 'std_dev', _atd_write_float, x.std_dev, x),
  };
}

export function readStats(x: any, context: any = x): Stats {
  return {
    mean: _atd_read_required_field('Stats', 'mean', _atd_read_float, x['mean'], x),
    std_dev: _atd_read_required_field('Stats', 'std_dev', _atd_read_float, x['std_dev'], x),
  };
}
...
export function writeParsingTime(x: ParsingTime, context: any = x): any {
  return {
    ...
    'per_file_time': _atd_write_required_field('ParsingTime', 'per_file_time', writeStats, x.per_file_time, x),
...
export function readParsingTime(x: any, context: any = x): ParsingTime {
  return {
    ...
    per_file_time: _atd_read_required_field('ParsingTime', 'per_file_time', readStats, x['per_file_time'], x),
