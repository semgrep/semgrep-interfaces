...
export function writePrefilteringStats(x: PrefilteringStats, context: any = x): any {
  return {
    ...
    'rules': _atd_write_required_field('PrefilteringStats', 'rules', _atd_write_int, x.rules, x),
...
export function readPrefilteringStats(x: any, context: any = x): PrefilteringStats {
  return {
    ...
    rules: _atd_read_required_field('PrefilteringStats', 'rules', _atd_read_int, x['rules'], x),
