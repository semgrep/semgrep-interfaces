...
| { kind: 'ResolutionOk'; value: [ScaDependency[], ResolutionError[]] }
...
export function writeResolutionResult(x: ResolutionResult, context: any = x): any {
  switch (x.kind) {
    case 'ResolutionOk':
      return ['ResolutionOk', ((x, context) => [_atd_write_array(writeScaDependency)(x[0], x), _atd_write_array(writeResolutionError)(x[1], x)])(x.value, x)]
...
export function readResolutionResult(x: any, context: any = x): ResolutionResult {
  ...
  switch (x[0]) {
    case 'ResolutionOk':
      return { kind: 'ResolutionOk', value: ((x, context): [ScaDependency[], ResolutionError[]] => { _atd_check_json_tuple(2, x, context); return [_atd_read_array(readScaDependency)(x[0], x), _atd_read_array(readResolutionError)(x[1], x)] })(x[1], x) }
    case 'ResolutionError':
