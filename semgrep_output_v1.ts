...
export type CiScanCompleteResponse = {
  ...
  app_blocking_match_based_ids: string[];
}
...
export function writeCiScanCompleteResponse(x: CiScanCompleteResponse, context: any = x): any {
  return {
    ...
    'app_blocking_match_based_ids': _atd_write_field_with_default(_atd_write_array(_atd_write_string), [], x.app_blocking_match_based_ids, x),
  };
}
...
export function readCiScanCompleteResponse(x: any, context: any = x): CiScanCompleteResponse {
  return {
    ...
    app_blocking_match_based_ids: _atd_read_field_with_default(_atd_read_array(_atd_read_string), [], x['app_blocking_match_based_ids'], x),
  };
}
