...
| { kind: 'ResolutionOk'; value: [[FoundDependency, Option<DownloadedDependency>][], ResolutionError[]] }
...
export function writeResolutionResult(x: ResolutionResult, context: any = x): any {
  switch (x.kind) {
    case 'ResolutionOk':
      return ['ResolutionOk', ((x, context) => [_atd_write_array(((x, context) => [writeFoundDependency(x[0], x), _atd_write_option(writeDownloadedDependency)(x[1], x)]))(x[0], x), _atd_write_array(writeResolutionError)(x[1], x)])(x.value, x)]
