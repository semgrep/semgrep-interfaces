// Generated by atdts from type definitions in 'semgrep_output_v0.atd'.
//
...
export function writeFinding(x: Finding, context: any = x): any {
  return {
    ...
    'pattern_based_id': _atd_write_required_field('Finding', 'pattern_based_id', _atd_write_string, x.pattern_based_id, x),
...
export function readFinding(x: any, context: any = x): Finding {
  return {
    ...
    pattern_based_id: _atd_read_required_field('Finding', 'pattern_based_id', _atd_read_string, x['pattern_based_id'], x),
